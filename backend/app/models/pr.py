...
class PersonalRecord(Base):
    ...
    exercise = relationship("Exercise") # Simple relationship, no back_populates needed on Exercise unless specified
    workout_log = relationship("WorkoutLog") # Simple relationship

    __table_args__ = (UniqueConstraint('athlete_id', 'exercise_id', 'reps', name='uq_athlete_exercise_reps'),)
