...
const coachLinks = [
  ...
  {
    name: 'Gest. Piani Nutrizionali',
    to: '/coach/nutrition-plan-management',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h10a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.688 11V6.343A2 2 0 019.688 4.5h4.624a2 2 0 012 2V11" /></svg>`
  },
];

const athleteLinks = [
  {
    name: 'Dashboard', // Simplified name
  ...
  },
  {
    name: 'Il Mio Profilo',
    to: '/athlete/profile',
    // Using a generic user icon, replace with a more specific one if available
  ...
  // Mio Storico is accessible via Profile or other means if still needed separately.
  // {
  //   name: 'Mio Storico',
  //   to: '/athlete/history',
  ...
  // },
  // I Miei Allenamenti and La Mia Nutrizione are now tabs in Profile
];
