<template>
  <div class="p-4">
    <h1 class="text-2xl font-bold mb-4">Gestione Piani di Allenamento</h1>
    ...
    <div v-else-if="!coachStore.workoutPlans || coachStore.workoutPlans.length === 0" class="text-center text-gray-500">
    ...
    <div v-else class="overflow-x-auto">
      <table class="table w-full">
        ...
        <tbody>
          <tr v-for="plan in coachStore.workoutPlans" :key="plan.id">
            <td>{{ plan.name }}</td>
...
onMounted(() => {
  coachStore.fetchCoachWorkoutData();
});
